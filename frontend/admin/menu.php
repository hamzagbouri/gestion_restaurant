...
<div class="flex min-h-screen h-full ">
    <aside class="w-[32rem] border-r min-h-full  flex flex-col items-center gap-16 ">
        <div class="mt-16">
    ...
    <section class="p-4 w-full flex flex-col gap-8">
                ...
                <div class="w-[40%] border flex flex-col gap-2 rounded-lg p-2">
                    <div class="flex justify-between">
                        ...
                        <div class="flex gap-2">
                            ...
                            <img class="w-4 h-4"  src="img/delete.png" alt="edit">
                        </div>
                    </div>
        ...
        <div class="w-full m-8 h-[90%] border border-2 border-black overflow-auto rounded-3xl bg-white relative z-50 md:w-2/4">
            ...
            <path fill="#5051fa" d="m13.537 12l3.855-3.855a1.091 1.091 0 0 0-1.542-1.541l.001-.001l-3.855 3.855l-3.855-3.855A1.091 1.091 0 0 0 6.6 8.145l-.001-.001l3.855 3.855l-3.855 3.855a1.091 1.091 0 1 0 1.541 1.542l.001-.001l3.855-3.855l3.855 3.855a1.091 1.091 0 1 0 1.542-1.541l-.001-.001z" />
            </svg>

            <div class="flex flex-col p-4">
            <h3 class="flex justify-center items-center" id="modal-title">Add Menu</h3>
            <form id="menu-form" method="post" action="addMenu.php" enctype="multipart/form-data" class="flex flex-col pt-16 gap-4">

                <div class="flex flex-col">
                <label for="menu-title">Menu Title</label>
                <input class="border border-gray-200 border-2 rounded-lg p-2" type="text" id="menu-title" name="menu-title">
                </div>

                <div class="flex flex-col">
                <label for="menu-price">Price</label>
                <input class="border border-gray-200 border-2 rounded-lg p-2" type="number" id="menu-price" name="menu-price">
                </div>

                <div id="plats-container" class="flex flex-col gap-4">
                <div class="plat-fields flex flex-col gap-2">
                    <h4 class="text-lg font-semibold">Plat 1</h4>
                    <div class="flex flex-col">
                    <label for="plat-title-1">Plat Title</label>
                    <input class="border border-gray-200 border-2 rounded-lg p-2" type="text" id="plat-title-1" name="plat-title-1">
                    </div>

                    <div class="flex flex-col">
                    <label for="plat-image-1">Image</label>
                    <input class="border border-gray-200 border-2 rounded-lg p-2" type="file" id="plat-image-1" name="plat-image-1">
                    </div>

                    <div class="flex flex-col">
                    <label for="plat-category-1">Category</label>
                    <input class="border border-gray-200 border-2 rounded-lg p-2" type="text" id="plat-category-1" name="plat-category-1">
                    </div>

                    <div class="flex flex-col">
                    <label for="plat-description-1">Description</label>
                    <textarea class="border border-gray-200 border-2 rounded-lg p-2" id="plat-description-1" name="plat-description[]"></textarea>
                    </div>
                </div>
                </div>

                <button type="button" id="add-plat" class="bg-gray-300 text-black rounded-lg px-4 py-2">Add Plat</button>
                    <input type="hidden" id="nbr_plat" value="1">
                <button type="submit" name="submit" class="bg-blue-500 text-white rounded-lg px-4 py-2">Add Menu</button>
            </form>
            </div>
        </div>
        </div>
        <div id="modal-edit" class="modal-edit bg-black bg-opacity-75 hidden items-center justify-center fixed inset-0 z-50">
  <div class="w-full m-8 h-[90%] border border-2 border-black overflow-auto rounded-3xl bg-white relative z-50 md:w-2/4">
    <svg class="fill-primary absolute cursor-pointer top-0 right-0 pr-4 pt-2 w-10 h-8 " onclick="closeModal()" xmlns="http://www.w3.org/2000/svg" width="1.2rem" height="1.2rem" viewBox="0 0 24 24">
      <path d="M20.48 3.512a11.97 11.97 0 0 0-8.486-3.514C5.366-.002-.007 5.371-.007 11.999c0 3.314 1.344 6.315 3.516 8.487A11.97 11.97 0 0 0 11.995 24c6.628 0 12.001-5.373 12.001-12.001c0-3.314-1.344-6.315-3.516-8.487m-1.542 15.427a9.8 9.8 0 0 1-6.943 2.876c-5.423 0-9.819-4.396-9.819-9.819a9.8 9.8 0 0 1 2.876-6.943a9.8 9.8 0 0 1 6.942-2.876c5.422 0 9.818 4.396 9.818 9.818a9.8 9.8 0 0 1-2.876 6.942z" />
      <path fill="#5051fa" d="m13.537 12l3.855-3.855a1.091 1.091 0 0 0-1.542-1.541l.001-.001l-3.855 3.855l-3.855-3.855A1.091 1.091 0 0 0 6.6 8.145l-.001-.001l3.855 3.855l-3.855 3.855a1.091 1.091 0 1 0 1.541 1.542l.001-.001l3.855-3.855l3.855 3.855a1.091 1.091 0 1 0 1.542-1.541l-.001-.001z" />
  ...
  function closeModal() {
    ...
    platsContainer.innerHTML = `
      <div class="plat-fields flex flex-col gap-2">
        ...
        <div class="flex flex-col">
          <label for="plat-description-1">Description</label>
          <textarea class="border border-gray-200 border-2 rounded-lg p-2" id="plat-description-1" name="plat-description-1"></textarea>
        </div>
      </div>`;
            ...
            <div id="modalEdit" class="modal bg-black bg-opacity-75 hidden items-center justify-center fixed inset-0 z-50 ">
                  <div class="w-full m-8 h-auto border border-2 border-black rounded-3xl bg-white relative z-50 md:w-1/4 ">
                    ...
                    <div class="flex flex-col">
                      ...
                      <input value="" class="border border-gray-200 border-2 rounded-lg p-2" type="text" id="email-input-edit" name="email-input-edit" >
                    </div>
                    <div class="flex flex-col">
